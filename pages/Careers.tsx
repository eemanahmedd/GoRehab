          ...
          <div className="bg-gradient-primary rounded-2xl p-12 text-white text-center">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
              <div>
                ...
                <h3 className="font-semibold mb-2 text-lg">Startup Energy</h3>
            ...
            <div className="bg-white/10 rounded-xl p-6 mb-8">
              <h3 className="font-semibold mb-4">What Our Team Members Say</h3>
              <blockquote className="text-blue-100 italic mb-4">
                "Working at GoRehab means knowing that every line of code I write helps students succeed. It's incredibly fulfilling to be part of transforming education in Pakistan."
              </blockquote>
              <div className="text-sm text-blue-200">— Ahmad, Lead Developer</div>
            </div>
          </div>
        </div>
      </section>
