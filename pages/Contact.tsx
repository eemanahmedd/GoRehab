import { Mail, Phone, MapPin, MessageCircle, FileText, Users, Apple, Smartphone } from "lucide-react";
          ...
          <div className="bg-gray-50 rounded-2xl p-8 shadow-lg">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600 text-sm mb-4">You can report issues through the app's feedback feature or email us directly at support@gorehab.com.</p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Can I suggest new features?</h4>
                <p className="text-gray-600 text-sm mb-4">Absolutely! We love hearing from our users. Use the feature request option in our support resources or contact us directly.</p>
