          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative">
              <ImageWithFallback
                ...
                alt="Students collaborating on GoRehab development"
          ...
          <div className="bg-gradient-to-r from-purple-50 to-orange-50 rounded-2xl p-8">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button variant="outline" className="border border-[var(--vibrant-purple)] text-[var(--vibrant-purple)] px-8 py-3 rounded-xl font-semibold hover:bg-[var(--vibrant-purple)] hover:text-white transition-colors">
                  Meet the Founders
                </Button>
              </div>
            </div>
