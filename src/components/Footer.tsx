...
export function Footer({ onNavigate }: FooterProps) {
  ...
  const support: Array<{
    ...
    { name: "Student Guide", page: "contact" },
    { name: "FAQ", page: "faq" },
  ];
  ...
  const socialLinks = [
    { icon: Facebook, href: "https://www.facebook.com/profile.php?id=61579172895335", label: "Facebook" },
    {
      icon: Instagram,
      href: "https://www.instagram.com/goreehab/",
      label: "Instagram",
    },
    { icon: Linkedin, href: "https://www.linkedin.com/company/gorehabilitation/", label: "LinkedIn" },
  ];
